...
#set SOURCE_FILE "$HDL_DIR/fsm.v"
#set SOURCE_FILE "$HDL_DIR/addr_ctl.v"
#set SOURCE_FILE "$HDL_DIR/pe.v"
#set SOURCE_FILE "$HDL_DIR/actquant.v"
set RPT_FILE "spyglass.rpt"
read_file -type verilog "$HDL_DIR/lenet.v"
read_file -type verilog "$HDL_DIR/fsm.v"
read_file -type verilog "$HDL_DIR/addr_ctl.v"
read_file -type verilog "$HDL_DIR/pe.v"
read_file -type verilog "$HDL_DIR/actquant.v"
